...
Output: index.html
Features: sidebar nav · mobile responsive · light/dark theme toggle
"""
...
PROFILE = {
    ...
    "about": [
        "I am a CIFRE PhD candidate in Applied Economics at Université Paris Dauphine – PSL, "
        "in partnership with Amundi Investment Solutions. My doctoral research, co-supervised "
        "by Yannick Le Pen (LEDa) and Thierry Roncalli (Amundi), investigates allocation biases "
        "in Net Zero passive investing — disentangling sectoral and geographical reallocation — "
        "and the integration of physical climate risk in portfolio management.",

        "I hold an MSc in Quantitative Finance from Dauphine (Mention Bien) and a Double BSc "
        "in Applied Economics from Dauphine and Goethe Universität Frankfurt. My academic work "
        "spans sustainable finance, ESG methodologies, stochastic calculus, machine learning, "
...
EDUCATION = [
    {
        "degree": "PhD in Applied Economics (CIFRE)",
    ...
    {
        "degree": "MSc in Quantitative Finance (272)",
    ...
    },
    {
        ...
        "details": (
            ...
            "Minor in Psychology · Courses: Economics, Mathematics, Statistics, Python & VBA, "
            "Accounting, Law, Social Sciences"
        ),
    },
]
...
RESEARCH = [
    {
        ...
        "description": (
            ...
            "reallocation from geographical reallocation, and evaluating their implications "
    ...
    },
    {
        ...
        "description": (
            ...
            "in portfolio management frameworks, asset pricing, and sovereign risk assessment."
        ),
    },
    {
...
PUBLICATIONS = [
    ...
    },
    {
        ...
        "title": "Second paper",
        "authors": "Bhaugeerutty, M. & Roncalli, T.",
